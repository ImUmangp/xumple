  ...
  const values = [
    {
      icon: Lightbulb,
      title: "Innovation",
      description: "We stay ahead of the curve, leveraging cutting-edge technology and creative strategies.",
    },
    {
      icon: Eye,
      title: "Transparency",
      description: "Clear communication, honest pricing, and open collaboration at every step.",
    },
    {
      icon: Heart,
    ...
    },
    {
      ...
      description: "Every decision is backed by analytics, A/B testing, and measurable outcomes.",
    },
    {
      icon: Shield,
      title: "Automation-first Mindset",
      description: "We build systems that scale, reducing manual work and maximizing efficiency.",
    },
    {
      icon: Users,
      title: "Long-term Partnerships",
      description: "We're not just a vendor—we're your growth partner, evolving with your needs.",
    },
  ];
    ...
    <div className="min-h-screen pt-20">
      <section className="py-20 lg:py-32 relative overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            To combine technology, promotion, automation, and brand strategy under one
            unified ecosystem, making growth simple, measurable, and affordable for every
            business.
          </p>
        </div>
      </section>
                ...
                <ul className="space-y-3 ml-6">
                  ...
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      ...
                      Driving growth through performance ads, influencer collaborations, and
                  ...
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      ...
                      operations with CRM systems, workflow automation, and business
                      intelligence
                    </span>
                  </li>
                </ul>
      ...
      <section className="py-20 lg:py-32">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 data-testid="text-values-title" className="text-3xl sm:text-4xl font-bold text-center mb-16">
            Our Values
          </h2>
      ...
      <section className="py-20 lg:py-32 bg-card/50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 data-testid="text-team-title" className="text-3xl sm:text-4xl font-bold text-center mb-16">
            Meet Our Team
          </h2>
